...
def circuit(j,string):  
    ...
    gamma = 0.03 #parameters gamma of amplitude damping
    
    
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[0]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[1]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[1]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[2]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[2]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[2]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[3]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[3]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[3]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[3]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[4]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[4]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[4]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[4]))
    circuit.append(cirq.DepolarizingChannel(gamma).on(qubits[4]))
